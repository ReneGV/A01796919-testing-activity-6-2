...
class TestReservation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        clear_data()
        Hotel.create_hotel("H1", "Grand", "NYC", 3)
    ...
    def test_cancel_reservation_not_found(self):
        ...
        self.assertFalse(Reservation.cancel_reservation("NOPE"))
    ...
    def test_cancel_reservation_already_cancelled(self):
        ...
        self.assertFalse(Reservation.cancel_reservation(r.reservation_id))

    def test_get_reservation_success(self):
        """get_reservation returns the correct Reservation object."""
        r = Reservation.create_reservation("C1", "H1")
        found = Reservation.get_reservation(r.reservation_id)
    ...
    def test_get_reservation_not_found(self):
        ...
        self.assertIsNone(Reservation.get_reservation("NOPE"))


class TestReservationGetAll(unittest.TestCase):
    """Tests for Reservation.get_all_reservations."""

    def setUp(self):
        """Clear data and create base hotel and customer for each test."""
        clear_data()
        Hotel.create_hotel("H1", "Grand", "NYC", 3)
        Customer.create_customer("C1", "Alice", "a@test.com", "555")
    ...
    def test_get_all_reservations_empty(self):
        ...
        self.assertEqual(Reservation.get_all_reservations(), [])

    def test_get_all_reservations_returns_all(self):
        """get_all_reservations returns every saved reservation."""
        r1 = Reservation.create_reservation("C1", "H1")
        r2 = Reservation.create_reservation("C1", "H1")
    ...
    def test_get_all_reservations_returns_reservation_objects(self):
        """get_all_reservations returns a list of Reservation instances."""
