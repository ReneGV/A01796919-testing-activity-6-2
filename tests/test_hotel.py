...
from src.hotel import Hotel, HotelRepository
...
class TestHotel(unittest.TestCase):
    ...
    def test_modify_hotel_location(self):
        ...
        HotelRepository.create("H1", "Grand", "NYC", 5)
        self.assertEqual(
            HotelRepository.modify("H1", location="LA").location,
            "LA",
        )
